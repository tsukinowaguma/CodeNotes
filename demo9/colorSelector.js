...
colorSelector.prototype = {
	init(){	//初始化
		...
		this.paintSelectorPointer(this.ClickX,this.ClickY);
	},	
	setShaft(){	//初始化转色轴的颜色
		var ctx = this.shaft.getContext("2d");	
	...
	setSelector (){	//设置颜色盘颜色
		...
		var tailrgbCopy = [tailrgb[0],tailrgb[1],tailrgb[2]]; 
		var IGrd,
	...
	handleShaftClick(e){		//点击转轴时
		...
		this.setColorRGB(this.ClickX,this.ClickY);
		this.paintSelectorPointer(this.ClickX,this.ClickY,this.selectorCTX);
	},	
	...
	setColorRGB(posX,posY){ //设置this.selectRGB的值
		var r,g,b;
		var tailrgb = this.tailrgb;
